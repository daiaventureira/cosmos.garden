    ...
    return (
      <div>
        ...
        <div className="star-sign-name">
          <div>
            <div className="arrow" onClick={this.clickLeftBottom}>
              <Arrow />
            </div>
            ...
            <div className="arrow right" onClick={this.clickRightBottom}>
              <Arrow />
            </div>
          </div>
        </div>
        <div>
          <div className="horoscope-of-day">
            <blockquote>
              {this.props.messages[this.state.counter - 1]}
            </blockquote>
          </div>
        </div>
      </div>
